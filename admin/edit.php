   ...
   //if(!isset($_SESSION['username'])){
    ...
    if(isset($_GET['id'])){
      ...
      if(mysqli_num_rows($edit_query_run)>0){
        ...
        $e_date_of_birth = $edit_row['date_of_birth'];
...
<div style="padding-left: 200px">
  ...
  <p align="center" style="font-size:30px;font-style:Arial">EDIT USER HERE</p>
  <form method="POST" action="edit.php" id="registrationForm" style="padding-left: 100px;padding-top: 50px;padding-bottom: 50px;background-color: pink;padding-right: 100px">
      
  <div>
    <label for= "firstname">First name :<span class="text-danger">*</span></label>
    <input type="text" name="first_name" id="firstname" maxLength="10" value="<?php echo $e_firstname;?>">
    <?php
  ...
  <div>
    ...
    <input type="text" name="last_name" id="lastname" placeholder="last name" maxLength="10" value="<?php echo $e_lastname;?>"> 
 <?php
...
<div>
  ...
  <div>
    ...
    <input type="text" name="username" id="username" value="<?php echo $e_username;?>">
    <?php
...
if(isset($passwordError)){
  ...
  <div>
    ...
    <input type="date" name="date_of_birth" id="dateofbirth" value="<?php echo $e_date_of_birth;?>">
  </div>
  <div>
